        ...
        <div className="todo_item">
            ...
            <div className="desc_wrap">
                ...
                {showEditArea ? null : <button className="edit_btn" onClick={handleEditClick}>
                    <img src={require("./edit-246.png")} alt=""/>
                </button>}
            </div>
            ...
            <div className="flex_wrap"><p>{props.creationDate}</p>
                ...
                <button className="delete_btn" onClick={handleDeleteClick}><img src="https://media.istockphoto.com/id/1162428585/vector/bin-icon-flat-red-round-button-vector-illustration.jpg?s=170667a&w=0&k=20&c=zQ9OF1K1oaRyETY1aTUAC-baKHgSWHDCKY9VDSpyu7w=" alt=""/></button>
            </div>
        </div>
    )
}
